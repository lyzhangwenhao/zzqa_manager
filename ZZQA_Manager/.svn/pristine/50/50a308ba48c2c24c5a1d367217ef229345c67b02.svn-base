package com.zzqa.pojo.product_procurement;

import java.io.Serializable;

public class Product_procurement implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -2122009322725630949L;
	private String name;//格式如：生产采购-2016年03月28日
	private int id;
	private int create_id;
	private int receive_id;//接收人id（采购人员）
	private int aog_id;//到货确认人(生产主管)
	private int check_id;//验货人(生产主管)
