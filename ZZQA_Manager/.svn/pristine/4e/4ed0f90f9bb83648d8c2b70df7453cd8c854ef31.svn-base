							...
							<div class="dropdown-menu">
								<div class="live-filtering" data-clear="true" data-autocomplete="true" data-keys="true">
									...
									<div class="list-to-filter">
										...
										<c:forEach items="${contractNos}" var="con_no" varStatus="status_sales">
										<li class="filter-item items" data-filter='<c:out value="${con_no.contract_no}"></c:out>' data-value="<c:out value="${con_no.sales_id}"></c:out>"><c:out value="${con_no.contract_no}"></c:out></li>
										</c:forEach>
										</ul>
