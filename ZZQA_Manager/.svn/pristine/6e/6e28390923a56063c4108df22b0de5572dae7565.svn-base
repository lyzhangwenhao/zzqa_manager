...
<link rel="stylesheet" type="text/css" href="css/create_productflow.css">
	...
	function addFlow() {
		...
		for (var i = 1; i < procurement_num + 1; i++) {
			if (document.getElementById("table1_tr" + i)) {
				...
				if (name != null && name.length > 0 && agent != null
					...
					if (k == 1) {
						product_value = name + "の" + agent + "の" + model + "の"+ materials_code + "の"
								+ num + "の" + unit;
					} else {
						product_value += "い" + name + "の" + agent + "の" + model+ "の" + materials_code
								+ "の" + num + "の" + unit;
					}
				} else {
		...
		if (name != null && name.length > 0 && agent != null
			...
			if (product_value.length < 1) {
				product_value = name + "の" + agent + "の" + model+ "の" + materials_code + "の" + num
						+ "の" + unit;
			} else {
				product_value += "い" + name + "の" + agent + "の" + model + "の"+ materials_code + "の"
						+ num + "の" + unit;
			}
		} else {
			initdiglog2("提示信息", "第 " + k + "行信息不正确！");
			...
			if (n == 0) {
				for (var i = procurement_num - 1; i >= 0; i--) {
					if (document.getElementById("table1_tr" + i)) {
						...
						document.getElementById("name0").value = document
								.getElementById("name" + i).value;
						document.getElementById("agent0").value = document
								.getElementById("agent" + i).value;
						document.getElementById("model0").value = document
								.getElementById("model" + i).value;
						document.getElementById("materials_code0").value = document
								.getElementById("materials_code" + i).value;
						document.getElementById("num0").value = document
								.getElementById("num" + i).value;
						document.getElementById("unit0").value = document
								.getElementById("unit" + i).value;
		...
		<table class="table_center">
			<tr>
				...
				<td class="table_center_td2">
					...
					<form
						action="FlowManagerServlet?type=addproductproflow"
							...
							<table class="td2_table2">
								<tr class="table2_tr1">
									...
									<td class="table2_tr1_td2" style="padding:10px;"colspan="3">
										<input type="text" name="product_name1" id="product_name1" style="height:20px;width:300px">
									</td>
								</tr>
							</table>
							<table class="td2_table1" id="td2_table1">
								<tr class="table1_tr1">
									<td class="table1_tr1_td1">产品名称</td>
									<td class="table1_tr1_td2">品牌/制造商</td>
									<td class="table1_tr1_td3">规格/型号</td>
									<td class="table1_tr1_td7">物料编码</td>
									<td class="table1_tr1_td4">数量</td>
									<td class="table1_tr1_td5">单位</td>
									<td class="table1_tr1_td6">操作</td>
								</tr>
								<tr class="table1_tr2" id="table1_tr0">
									<td class="table1_tr2_td1"><input type="text" id="name0"
										maxlength="50" focus></td>
									<td class="table1_tr2_td2"><input type="text" id="agent0"
										maxlength="50"></td>
									<td class="table1_tr2_td3"><input type="text" id="model0"
										maxlength="50"></td>
									<td class="table1_tr2_td7"><input type="text" id="materials_code0"
										maxlength="50"></td>
									<td class="table1_tr2_td4"><input type="text" id="num0"
										maxlength="9"
										onkeyup="this.value=this.value.replace(/\D/g,'')"
										onafterpaste="this.value=this.value.replace(/\D/g,'')">
									</td>
									<td class="table1_tr2_td5"><input type="text" id="unit0"
										maxlength="10"></td>
									<td class="table1_tr2_td6"><img src="images/delete.png"
										title="删除" onclick="del(0);"><img
										src="images/add_linkman.png" title="添加" onclick="add();">
									</td>
								</tr>
							</table>
