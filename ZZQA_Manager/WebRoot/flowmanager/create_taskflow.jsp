	...
	-->
		<script type="text/javascript">
			...
			function addFlow(){
				...
				if(document.flowform.consignee.value.length<1){
					k++;
					document.getElementById("consignee_error").innerText="请输入收货人";
				}else {
					document.getElementById("consignee_error").innerText="";
				}
				...
				if(document.flowform.other.value.replace(/\s+/g,"").length<1){
					initdiglog2("提示信息","请在移交项目中心一栏填写备注，若没有则填无!");
					k++;
				}
				var linkman_user="";
							...
							<div class="td2_div">
								...
								<table class="td2_table1">
									<tr class="table1_tr1">
										...
										<td class="table1_tr1_td2">
											<select id="pCategory" name="pCategory"  onchange="isFanProject()">
												<%for(int i=0;i<pCategoryArray.length;i++){ %>
													<option name="optionArr" value="<%=i%>"><%=pCategoryArray[i]%></option>
												<%} %>
											</select>
										</td>
									</tr>
									<tr class="table1_tr1">
										...
										<td class="table1_tr1_td2">
											<input type="hidden" id="productTypeValue" name="productTypeValue">
											<div id="fanProject">
									...
									<tr class="table1_tr2">
										...
										<td class="table1_tr2_td2">
											<input type="text" name="project_id" maxlength="50" oninput="checkNum(this)" required="required">
									...
									<tr class="table1_tr1">
										...
										<td class="table1_tr1_td2">
											<input type="number" name="fan_num" maxlength="50" required="required">
									...
									<tr class="table1_tr2">
										<td class="table1_tr2_td1">
											<span class="star">*</span>项目名称和主机厂家
										</td>
										<td class="table1_tr2_td2">
											<input type="text" name="factory" maxlength="100" required="required">
									...
									<tr class="table1_tr1">
										...
										<td class="table1_tr1_td2">
											<input type="number" name="submit_date" maxlength="50" required="required">
									...
									<tr class="table1_tr4">
										...
										<td class="table1_tr4_td2">
											<label><input name="contract_type" type="radio" value="试用" checked/>试用</label>
											<label><input name="contract_type" type="radio" value="签订技术协议">签订技术协议</label>
											<label><input name="contract_type" type="radio" value="签订合同及协议">签订合同及协议</label>
											<label><input name="contract_type" type="radio" value="其他">其他</label>
										</td>
									</tr>
									<tr class="table1_tr2">
										<td class="table1_tr2_td1">
										...
										<td class="table1_tr2_td2">
											<input type="text" name="equipment_type" maxlength="100" required="required">
									...
									<tr class="table1_tr3">
										...
										<td class="table1_tr3_td2">
											<input name="project_case" type="hidden" value="0"/>
										</td>
									</tr>
									<%--<tr class="table1_tr4">
										<td class="table1_tr4_td1">
								...
								<table class="td2_table2">
									...
									<tr class="table2_tr1">
										...
										<td class="table2_tr1_td2">
											<input type="text" name="consignee" maxlength="200">
									...
									<tr class="table2_tr6">
										...
										<td class="table2_tr6_td2">
											...
											<textarea style="color: red;font-weight: bold;" name="description" placeholder="此处输入项目说明和特殊要求(可选)"
									...
									<tr class="table2_tr8">
										...
										<td class="table2_tr8_td2" >
											...
											<textarea name="other" placeholder="特殊情况备注" maxlength="500"
