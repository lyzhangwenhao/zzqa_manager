...
%>
   <div id="bts-ex-6" class="selectpicker" data-live="true">
							...
							<div class="dropdown-menu">
								<div class="live-filtering" data-clear="true" data-autocomplete="true" data-keys="true">
									<label class="sr-only" for="input-bts-ex-6">在列表中搜索</label>
							...
							<input type="hidden" name="bts-ex-6" id="cname_input6" value="">
						</div>